                                      ...
                                      double _Kdp, double _Kdo)
{
   ...
   Eigen::Matrix<double,3,1> dot_e_o = computeOrientationVelocityError(omega_d,
                                                                       ...
                                                                       R_d,
                                                                       R_e);
   Eigen::Matrix<double,3,1> e_o_w = computeOrientationError(R_d,R_e);                                               
...
//    std::cout << "jacobian: " << std::endl << toEigen(robot_->getEEJacobian()) << std::endl;
...
//    std::cout << "q: " << std::endl << robot_->getJntValues() << std::endl;
//    std::cout << "Jac Dot qDot: " << std::endl << toEigen(robot_->getEEJacDotqDot()) << std::endl;
//    std::cout << "qdot: " << std::endl << robot_->getJntVelocities() << std::endl;
...
//    std::cout << "---------------------" << std::endl;
   ...
   y << dot_dot_x_d - toEigen(robot_->getEEJacDotqDot())*robot_->getJntVelocities() + Kd*dot_x_tilde + Kp*x_tilde;
